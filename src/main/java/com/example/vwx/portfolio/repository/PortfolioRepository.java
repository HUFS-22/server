...
public interface PortfolioRepository extends JpaRepository<Portfolio, Long> {
    ...
    @Query("SELECT DISTINCT new com.example.vwx.portfolio.dto.SearchPortfolioDto (p.title, p.coverImageUrl, u.userName, u.profileImageUrl) FROM Portfolio p INNER JOIN Users u ON p.users = u " +
    ...
    @Query(value = "SELECT DISTINCT new com.example.vwx.portfolio.dto.SearchPortfolioDto (p.title, p.coverImageUrl, u.userName, u.profileImageUrl) " +
